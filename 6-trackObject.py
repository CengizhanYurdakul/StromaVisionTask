    ...
    for videoName in videoNames:
        ...
        for _ in tqdm(range(total)):
            ...
            if ret == True:
                ...
                trackers = tracker.update((xyxy).to("cpu").numpy(), results[0].boxes.cls)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-w", "--modelPath", default="runs/detect/Optimizer-Adam_LR-0.01_Pretrained-True_Augmentation-True/weights/best.pt", help="Weights of model")
